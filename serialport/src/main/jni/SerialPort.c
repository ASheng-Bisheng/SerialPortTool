...
Java_com_xbs_serialport_jni_SerialPort_open(JNIEnv *env, jobject thiz, jstring path,
...
Java_com_xbs_serialport_jni_SerialPort_close(JNIEnv *env, jobject instance) {
